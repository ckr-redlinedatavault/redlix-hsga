              ...
              <form
                ...
                onSubmit={(e) => {
                  ...
                  try {
                    ...
                    if (!t) {
                      setError("No provisioned trainers found.");
                      return;
                    }
                    const trainers = JSON.parse(t) as Array<{id:string; name:string; schoolId:string; password:string}>;
                    const match = trainers.find(x => x.id === trainerId.trim() && x.password === password.trim());
                    if (match) {
