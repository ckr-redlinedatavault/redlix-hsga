...
import { Mail, Phone, MapPin, Facebook, Twitter, Instagram, ArrowRight, ShieldCheck } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-3">
                <Link
                  ...
                  className="p-3 border border-zinc-800 text-zinc-500 hover:text-amber-500 hover:border-amber-500/30 transition-all"
                >
                  <Facebook size={18} />
                </Link>
                <Link
              ...
              <div className="mt-4">
                <form
                  action="mailto:hsgatelangana@gmail.com"
                  method="post"
                  encType="text/plain"
                ...
                >
                  <input
                    ...
                    className="flex-1 px-3 py-2 text-[12px] bg-zinc-900 border border-zinc-800 text-zinc-200 placeholder:text-zinc-500 focus:outline-none focus:border-amber-500"
                  />
                  <button
                    type="submit"
                    className="px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] bg-amber-500 text-zinc-950 hover:bg-amber-400 transition-colors"
                  >
                    Subscribe
                  </button>
                </form>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <Link
                    href="/"
                    className="group flex items-center text-[13px] font-normal text-zinc-400 hover:text-white transition-colors"
                  >
              ...
              <div className="mt-8">
                <h4 className="text-[10px] font-bold uppercase tracking-[0.3em] text-white mb-4">
                  Quick Links
                </h4>
                <ul className="space-y-3">
                  <li>
                    <Link
                      href="/how-to-join"
                      className="text-[13px] font-normal text-zinc-400 hover:text-white transition-colors"
                    >
                      Become a Member
                    </Link>
                  </li>
            ...
            <div className="flex flex-col">
              ...
              <div className="relative group w-full h-48 bg-zinc-900 border border-zinc-800 overflow-hidden">
                <iframe
                  src={mapUrl}
                  title="Google Map Location of HSGA Telangana"
